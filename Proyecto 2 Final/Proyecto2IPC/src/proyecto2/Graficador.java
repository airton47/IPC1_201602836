...
public class Graficador {
    ...
    public String generarDot(NodoEscritorio primero){
        ...
        if(primero==null){
        	...
        	if(primero.getEstado()=="OCUPADO") {
        		cadena+="nodo"+reemplazar(primero.hashCode())+"[label=\"ESCRITORIO "+(primero.getLetter())+" "+"["+primero.getEstado()+"]"
        		+" "+"PILA DOCS "+primero.pila.contar()+"\n"+"PASAJERO ID "+primero.getPasajero().getId()+"\n"+"MALETAS "+primero.getPasajero().getMaletas()+"\n"
        		+"TURNOS RESTANTES "+primero.getPasajero().getTurnos()+"\n"+"DOCUMENTOS PASAJERO "+primero.getPasajero().getDocumentos()+"\"];\n";
        	}else {
        		cadena+="nodo"+reemplazar(primero.hashCode())+"[label=\"ESCRITORIO "+(primero.getLetter())+" "+"["+primero.getEstado()+"]"+"\"];\n";
        	}
            if(primero.siguiente!=null){
            	if(primero.siguiente==null /*&& primero.cola!=null && primero.cola.primero!=null*/) {
                	System.out.println("AL PARECER SI ENTRA EN ESTA PARTE DEL GRAFICADOR");
                	System.out.println("	LA LETRA DEL DESK ES: "+primero.siguiente.getLetter());
    ...
    public String generarDot(NodoEstacion primero){
        ...
        if(primero==null){
        	...
        	+"AVION "+primero.getAvion().getId()+" "+"["+primero.getAvion().getTipo()+"]"+"\n"+"TURNOS "+primero.getAvion().getNumberM()+"\"];\n";
        	}else {
        		cadena+="nodo"+reemplazar(primero.hashCode())+"[label=\"ESTACION "+(primero.getId())+" "+"["+primero.getEstado()+"]"+"\"];\n";
        	}
            if(primero.siguiente!=null){
